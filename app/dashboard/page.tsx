...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-purple-800 via-purple-900 to-indigo-950 text-white">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <header className="flex justify-between items-center mb-8 backdrop-blur-sm bg-white/5 rounded-2xl p-4">
          ...
          <Avatar className="h-12 w-12 ring-2 ring-purple-500/30 transition-all hover:ring-purple-500/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="md:col-span-3 bg-white/5 border-white/10 backdrop-blur-md">
            <CardHeader>
              <CardTitle className="text-xl text-purple-100">Now Playing</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <div className="flex items-center">
                  <div className="relative group">
                    <img src="/placeholder.svg" alt="Album cover" 
                      className="w-20 h-20 rounded-xl mr-6 ring-2 ring-purple-500/30 transition-all group-hover:ring-purple-500/50" />
                    <div className="absolute inset-0 bg-purple-500/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold text-purple-100">Song Title</h3>
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-md">
            <CardHeader>
              <CardTitle className="text-xl text-purple-100">Add a Song</CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleAddSong} className="space-y-4">
                <Input 
                  ...
                  className="bg-white/10 border-purple-500/30 placeholder-purple-300/50 text-purple-100 focus:border-purple-500/50" 
                />
                <Button type="submit" 
                  className="w-full bg-purple-500/20 hover:bg-purple-500/30 text-purple-100 border-purple-500/30">
          ...
          <Card className="md:col-span-2 bg-white/5 border-white/10 backdrop-blur-md">
            <CardHeader>
              <CardTitle className="text-xl text-purple-100">Vote for Next Song</CardTitle>
            </CardHeader>
            <CardContent>
              <ScrollArea className="h-[400px] pr-4">
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={song.id} 
                      className="flex items-center justify-between bg-purple-500/5 hover:bg-purple-500/10 p-4 rounded-xl border border-purple-500/20 transition-all">
                      <div className="flex items-center">
                        <div className="relative group">
                          <img src={song.thumbnail} alt={`${song.title} thumbnail`} 
                            className="w-14 h-14 rounded-lg mr-4 ring-2 ring-purple-500/30 transition-all group-hover:ring-purple-500/50" />
                          <div className="absolute inset-0 bg-purple-500/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity" />
                        </div>
                        <div>
                          <h4 className="font-semibold text-purple-100">{song.title}</h4>
                          <p className="text-sm text-purple-300">{song.artist}</p>
                        </div>
                      </div>
                      <div className="flex items-center space-x-3">
                        <span className="text-sm font-medium bg-purple-500/20 px-3 py-1 rounded-full text-purple-100">
                          {song.votes} votes
                        </span>
